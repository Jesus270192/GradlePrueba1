...
public class MongoDBConexion {
    ...
    private String _cadenaDeConcexion ="mongodb+srv://admin:admin@cluster0.kq370.mongodb.net/sample_airbnb?retryWrites=true&w=majority";
    ...
    public MongoDBConexion(){
        ...
        _database = mongoClient.getDatabase("sample_airbnb");
    }
